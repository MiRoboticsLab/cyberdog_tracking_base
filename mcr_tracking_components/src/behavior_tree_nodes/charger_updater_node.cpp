...
void ChargerUpdater::callback_updated_goal(
  ...
  RCLCPP_WARN(
      node_->get_logger(),
      "auto recharge points: (%f, %f), (%f, %f), (%f, %f).",
      pose_based_on_global_frame.pose.position.x,
      pose_based_on_global_frame.pose.position.y,
      global_frame_pose_b.pose.position.x, global_frame_pose_b.pose.position.y,
      global_frame_pose.pose.position.x, global_frame_pose.pose.position.y);
