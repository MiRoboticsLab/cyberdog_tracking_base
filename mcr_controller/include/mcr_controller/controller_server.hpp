...
#ifndef MCR_CONTROLLER__MCR_CONTROLLER_HPP_
#define MCR_CONTROLLER__MCR_CONTROLLER_HPP_
...
/**
 * @class mcr_controller::ControllerServer
...
public:
  ...
  /**
   * @brief Constructor for mcr_controller::ControllerServer
   */
  ControllerServer();
  /**
   * @brief Destructor for mcr_controller::ControllerServer
   */
  ~ControllerServer();
...
protected:
  ...
  std::vector<std::string> default_costmaps_;
  std::vector<std::string> controller_costmaps_;
  std::string controller_ids_concat_, current_controller_;

  CostmapMap costmaps_;
  PlannerCostmapMap pcmaps_;
...
#endif  // MCR_CONTROLLER__MCR_CONTROLLER_HPP_
