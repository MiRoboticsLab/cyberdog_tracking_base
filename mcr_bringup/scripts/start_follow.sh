...
ros2 service call /lifecycle_manager_mcr_uwb/manage_nodes nav2_msgs/srv/ManageLifecycleNodes "{command: 0}"
...
ros2 service call /lifecycle_manager_mcr_uwb/manage_nodes nav2_msgs/srv/ManageLifecycleNodes "{command: 1}"
