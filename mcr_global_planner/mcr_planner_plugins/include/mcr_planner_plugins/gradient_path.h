...
protected:
  bool shouldGridStep(const mcr_global_planner::PotentialGrid& potential_grid,
                    const mcr_nav_grid::Index& index);
                    
  mcr_nav_grid::Index gridStep(const mcr_global_planner::PotentialGrid& potential_grid,
                            const mcr_nav_grid::Index& index);

  inline void calculateGradient(const mcr_global_planner::PotentialGrid& potential_grid,
                                const mcr_nav_grid::Index& index);
