...
void MCRCurvePlanner::configure(
    ...
    nav2_util::declare_parameter_if_not_declared(node_, name_ + ".turning_radius", rclcpp::ParameterValue(0.3));
    node_->get_parameter(name_ + ".turning_radius", turning_radius_);
    nav2_util::declare_parameter_if_not_declared(node_, name_ + ".curve_type", rclcpp::ParameterValue("dubins"));
...
nav_msgs::msg::Path MCRCurvePlanner::createPlan(const geometry_msgs::msg::PoseStamped & start,
