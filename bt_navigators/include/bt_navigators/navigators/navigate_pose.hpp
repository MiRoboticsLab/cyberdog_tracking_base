...
#ifndef BT_NAVIGATORS__NAVIGATORS__NAVIGATE_POSE_HPP_
#define BT_NAVIGATORS__NAVIGATORS__NAVIGATE_POSE_HPP_
 ...
 */
class NavABNavigator
  : public bt_navigators::Navigator<nav2_msgs::action::NavigateToPose>
{
public:
  using ActionT = nav2_msgs::action::NavigateToPose;

  /**
   * @brief A constructor for NavABNavigator
   */
  NavABNavigator()
  : Navigator() {}
...
protected:
  ...
  bool onGoalUpdate(FollowPoses::SharedPtr msg) override;
...
#endif  // BT_NAVIGATORS__NAVIGATORS__NAVIGATE_POSE_HPP_
