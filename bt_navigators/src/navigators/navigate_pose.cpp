...
#include <memory>
#include <limits>
#include "bt_navigators/navigators/navigate_pose.hpp"
  ...
  rclcpp_lifecycle::LifecycleNode::WeakPtr parent_node)
{
  ...
  goal_sub_ = node->create_subscription<geometry_msgs::msg::PoseStamped>(
    ...
    std::bind(&NavABNavigator::onGoalPoseReceived, this, std::placeholders::_1));
  return true;
}

std::string NavABNavigator::getDefaultBTFilepath(
  rclcpp_lifecycle::LifecycleNode::WeakPtr parent_node)
{
...
bool NavABNavigator::goalReceived(ActionT::Goal::ConstSharedPtr goal)
{
...
void NavABNavigator::goalCompleted(typename ActionT::Result::SharedPtr /*result*/)
{
}

void NavABNavigator::onLoop()
{
...
void
NavABNavigator::onPreempt(ActionT::Goal::ConstSharedPtr goal)
{
...
void
NavABNavigator::initializeGoalPose(ActionT::Goal::ConstSharedPtr goal)
{
  RCLCPP_INFO(
...
void
NavABNavigator::onGoalPoseReceived(const geometry_msgs::msg::PoseStamped::SharedPtr pose)
{
  ActionT::Goal goal;
  goal.pose = *pose;
