...
#include "bt_navigators/navigators/auto_docking.hpp"
...
bool AutoDockingNavigator::configure(
  rclcpp_lifecycle::LifecycleNode::WeakPtr parent_node)
{
  start_time_ = rclcpp::Time(0);
  RCLCPP_ERROR(logger_, "AutoDockingNavigator configure:.");
  ...
  goal_sub_ = node->create_subscription<geometry_msgs::msg::PoseStamped>(
    ...
    std::bind(
      &AutoDockingNavigator::onGoalPoseReceived, this,
      std::placeholders::_1));
  return true;
}

std::string AutoDockingNavigator::getDefaultBTFilepath(
  rclcpp_lifecycle::LifecycleNode::WeakPtr parent_node)
{
...
bool AutoDockingNavigator::cleanup()
{
  goal_sub_.reset();
  self_client_.reset();
  return true;
...
bool AutoDockingNavigator::goalReceived(
...
bool AutoDockingNavigator::onGoalUpdate(FollowPoses::SharedPtr msg)
{
  (void)msg;
  return true;
}

void AutoDockingNavigator::goalCompleted(
  typename ActionT::Result::SharedPtr /*result*/) {}

void AutoDockingNavigator::onLoop()
{
...
void AutoDockingNavigator::onPreempt(ActionT::Goal::ConstSharedPtr goal)
{
...
void AutoDockingNavigator::initializeGoalPose(
  ActionT::Goal::ConstSharedPtr /*goal*/)
{
...
void AutoDockingNavigator::onGoalPoseReceived(
