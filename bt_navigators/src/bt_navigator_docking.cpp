...
#include "bt_navigators/bt_navigator_docking.hpp"
...
BtNavigatorDock::BtNavigatorDock()
: nav2_util::LifecycleNode("bt_navigator_docking", "", false)
{
...
BtNavigatorDock::on_configure(const rclcpp_lifecycle::State & /*state*/)
{
  ...
  automatic_recharge_navigator_ = std::make_unique<bt_navigators::AutoDockingNavigator>();
...
nav2_util::CallbackReturn
BtNavigatorDock::on_activate(const rclcpp_lifecycle::State & /*state*/)
{
...
nav2_util::CallbackReturn
BtNavigatorDock::on_deactivate(const rclcpp_lifecycle::State & /*state*/)
{
...
nav2_util::CallbackReturn
BtNavigatorDock::on_cleanup(const rclcpp_lifecycle::State & /*state*/)
{
...
nav2_util::CallbackReturn
BtNavigatorDock::on_shutdown(const rclcpp_lifecycle::State & /*state*/)
{
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<bt_navigators::BtNavigatorDock>();
