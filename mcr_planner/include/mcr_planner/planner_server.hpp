...
{
/**
 * @class mcr_planner::PlannerServer
...
public:
  /**
   * @brief A constructor for mcr_planner::PlannerServer
   */
  PlannerServer();
  /**
   * @brief A destructor for mcr_planner::PlannerServer
   */
  ~PlannerServer();
...
protected:
  ...
  std::vector<std::string> planner_costmaps_;
